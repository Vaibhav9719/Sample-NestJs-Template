...
> Note: NestJS Base Project uses [TypeORM](https://github.com/typeorm/typeorm) with Data Mapper pattern.
...
create database `nest_base_project` and your application fully is ready to use.
